...
That is the entire shipped CLI — there are no other commands or flags, and `docs/cli-reference.md` documents every one. Section 6 is the design record the v0.8 additions shipped from. Behavior notes:
