...
const ID_RE = /^(?:S\d{2}|SHL-\d{2}|PIP-\d{2}|EXC-\d{2}|INC-\d{2}|LAY-\d{2}|MRG-\d{2}|HED-\d{2}|ATT-\d{2}|MD-\d{2}|URL-\d{2}|REF-\d{2}|COL-\d{2}|DIA-\d{2}|P\d{2}|A\d{2}|PUB-\d{2}|WCH-\d{2}|DRY-\d{2}|CFG-\d{2}|SCF-\d{2}|FIX-\d{2}|MAN-\d{2}|SIT-\d{2}|CAN-\d{2}|ROB-\d{2})$/;
